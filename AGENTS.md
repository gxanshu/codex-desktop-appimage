...
- Treat launcher, feature framework, and patch registry changes as
  cross-format concerns; this fork only ships AppImage, but features and
  patches must continue to apply cleanly for upstream compatibility.
